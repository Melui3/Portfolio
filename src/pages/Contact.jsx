    ...
    <div className="max-w-5xl mx-auto px-6 py-16">
      ...
      <div className="mb-14 scroll-reveal">
        ...
        <p className="font-body text-muted max-w-2xl">
          Décrivez-moi votre besoin, même si tout n’est pas encore clair. Je vous réponds sous 48h
          avec une première lecture du projet, les prochaines étapes et une fourchette réaliste.
        </p>
      </div>
